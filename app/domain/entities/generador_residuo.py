...
class GeneradorResiduo:
    def __init__(self, id: UUID, ruc: str, razon_social: Optional[str], direccion: Optional[str], id_distrito: UUID,
                 dni_responsable: Optional[str], nombre_responsable: Optional[str], telefono: Optional[str],
                 correo: Optional[str], created_at: datetime, updated_at: datetime):
        self.id = id
        self.ruc = ruc
